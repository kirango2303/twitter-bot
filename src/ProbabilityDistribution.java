...
class ProbabilityDistribution<T extends Comparable<T>> {
     ...
     * @throws IllegalArgumentException if a number recieved from the generator is
     *                                  less than zero or greater than the total
     ...
     * @throws IllegalArgumentException if the element is not in the distribution
     */

...
public class ListNumberGenerator implements NumberGenerator {
    ...
    /**
     * Creates a ListNumberGenerator which generates numbers based off of a list of
     * possible integers.
     *
    ...
    /**
     * Creates a ListNumberGenerator which generates numbers based off of an array
    ...
    public int next(int bound) {
        if (bound <= smallestUpperBound) {
            throw new NoSuchElementException(
                    "The list contains no elements " + "less than or equal to the argued bound");
        }
